...
def get_hash_functions():
    hash_functions = []
    hash_functions.append(nearpy.hashes.RandomBinaryProjections('rand binary proj', 10, 1234))
    hash_functions.append(nearpy.hashes.PCABinaryProjections('pca binary proj', 10, np.random.random((20,10))))
    hash_functions.append(nearpy.hashes.PCADiscretizedProjections('pca discr proj', 10, np.random.random((20,10)), 3))
    hash_functions.append(nearpy.hashes.RandomBinaryProjectionTree('rand binary proj tree', 10, 5, 1234))
    hash_functions.append(nearpy.hashes.RandomDiscretizedProjections('rand discr proj', 10, 5, 1234))
